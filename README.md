...
The primary objective of this project was to learn how to build an API using Node.js. The API forms a crucial component of a larger application that we plan to develop in the subsequent two stages of the course.

The API was specifically designed to function as a database for storing useful links and notes. To accomplish this, were utilized tools as SQLite, Beekeeper Studio, and Query Builder Knex.js. These tools were instrumental in creating a robust and efficient database that can store large amounts of data securely.

Overall, this project was an exciting opportunity to gain practical experience in building APIs using Node.js and working with cutting-edge database technologies. The skills and knowledge gained from this project will be invaluable in future development work and in enhancing our abilities as developers.
...
```bash
$ git clone git@github.com:jeadamek/rocketNotes_api.git
$ cd rocketNotes_api
```
